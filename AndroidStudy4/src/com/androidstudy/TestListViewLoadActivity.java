...
public class TestListViewLoadActivity extends ListActivity implements
		OnScrollListener
{
	private static final String	TAG				= "TestListViewLoadActivity";
	...
	class listViewAdapter extends BaseAdapter
	{
		...
		public View getView(int pos, View v, ViewGroup p)
		{
			...
			if (v == null)
			{
				view = new TextView(TestListViewLoadActivity.this);
			} else
			{
				view = (TextView) v;
			}
